...
class Moderation(commands.Cog):
  ...
  async def unlockall(self, ctx, server: discord.Guild = None, *, reason=None):
    hacker = discord.Embed(
      color=0x0d0d13,
      description=
      "<:IconTick:1213170250267492383> | Unlocking all channels in few seconds .",
  ...
  async def lockall(self, ctx, server: discord.Guild = None, *, reason=None):
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      "<:IconTick:1213170250267492383> | Locking all channels in few seconds .",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
    await ctx.reply(embed=hacker)
  ...
  async def hackban(self, ctx, userid, *, reason=None):
    ...
    try:
      ...
      await ctx.reply(embed=discord.Embed(
        description=
        f"<:IconTick:1213170250267492383> | Successfully hackbanned {userid} for {reason}",
        color=0x00FFCA))
    except:
      await ctx.reply(embed=discord.Embed(
  ...
  async def give(
    ...
    if guild.me.top_role >= ctx.author.top_role:
      embed = discord.Embed(
        color=0x00FFCA,
        description=
        "<:IconTick:1213170250267492383> | Your role is below the bot.")
      await ctx.send(embed=embed)
      return
    if member.top_role >= ctx.author.top_role:
      await ctx.send(
        "**<:crosss:1212440602659262505> | The provided user has roles that are above or have the same role as you.**"
      )
      return
    else:
  ...
  async def _hideall(self, ctx):
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      "<:IconTick:1213170250267492383> | Hiding all channels in few seconds .",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
  ...
  async def _unhideall(self, ctx):
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | Unhiding all channels in few seconds .",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
    #hacker.set_thumbnail(url =f"{ctx.author.avatar}")
  ...
  async def _hide(self, ctx, channel: discord.TextChannel = None):
    ...
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | Succefully Hidden {channel.mention} .",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
    hacker.set_thumbnail(url=f"{ctx.author.avatar}")
  ...
  async def _unhide(self, ctx, channel: discord.TextChannel = None):
    ...
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | Succefully Unhidden {channel.mention} .",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
    hacker.set_thumbnail(url=f"{ctx.author.avatar}")
...
Reason: `{entry.reason}`\n\n''')
  ...
  async def _prefix(self, ctx: commands.Context, prefix):
    ...
    if ctx.author.id in mod:
      ...
      await ctx.reply(embed=discord.Embed(
        description=
        f"<:IconTick:1213170250267492383> | Successfully Changed Prefix For **{ctx.guild.name}**\nNew Prefix for **{ctx.guild.name}** is : `{prefix}`\nUse `{prefix}help` For More info .",
        color=0x00FFCA))
    else:
  ...
  async def _softban(self,
    ...
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | Sucessfully soft-banned {member}.",
      timestamp=ctx.message.created_at)
  ...
  async def purge(self, ctx, amount: int = 10):
    ...
    return await ctx.send(
      f"**<:IconTick:1213170250267492383> Deleted {len(deleted)-1} message(s)**"
    )
  ...
  async def startswith(self, ctx, key, amount: int = 10):
    ...
    return await ctx.send(
      f"**<:IconTick:1213170250267492383> Deleted {len(deleted)}/{amount} message(s) which started with the given keyword**"
    )
  ...
  async def endswith(self, ctx, key, amount: int = 10):
    ...
    deleted = await ctx.channel.purge(limit=100, check=check)
    return await ctx.send(
      f"**<:IconTick:1213170250267492383> Deleted {len(deleted)}/{amount} message(s) which ended with the given keyword**"
    )
  ...
  async def contains(self, ctx, key, amount: int = 10):
    ...
    deleted = await ctx.channel.purge(limit=100, check=check)
    return await ctx.send(
      f"**<:IconTick:1213170250267492383> Deleted {len(deleted)}/{amount} message(s) which contained the given keyword**"
    )
  ...
  async def user(self, ctx, user: discord.Member, amount: int = 10):
    ...
    deleted = await ctx.channel.purge(limit=100, check=check)
    return await ctx.send(
      f"**   <:IconTick:1213170250267492383> Deleted {len(deleted)}/{amount} message(s) which were sent by the mentioned user**"
    )
  ...
  async def invites(self, ctx, amount: int = 10):
    ...
    deleted = await ctx.channel.purge(limit=100, check=check)
    return await ctx.send(
      f"**<:IconTick:1213170250267492383> Deleted {len(deleted)}/{amount} message(s) which contained invites**"
    )

  @commands.hybrid_command(name="mute",
                           description="Timeouts someone for specific time.",
                           usage="mute <member> <time>",
                           aliases=["timeout", "stfu","maachuda"])
  ...
  async def _mute(self, ctx, member: discord.Member, duration):
    ...
    if tame == -1:
      hacker3 = discord.Embed(
        color=0x2f3136,
        description=
        f"<:crosss:1212440602659262505> | You didnt didnt gave time with correct unit\nExamples:\n{ctx.prefix}mute{ctx.author} 10m\n{ctx.prefix}mute {ctx.author} 5hr",
        timestamp=ctx.message.created_at)
      await ctx.reply(embed=hacker3, mention_author=False)
    elif tame == -2:
      hacker4 = discord.Embed(
        color=0x2f3136,
        description=f"<:crosss:1212440602659262505> | Time must be an integer!",
        timestamp=ctx.message.created_at)
      ...
      if till.lower() == "d":
        ...
        hacker = discord.Embed(
          color=0x2f3136,
          description=
          "<:IconTick:1213170250267492383> | Successfully Muted {0.mention} For {1} Day(s)"
          .format(member, ok),
          timestamp=ctx.message.created_at)
      elif till.lower() == "m":
        t = timedelta(seconds=tame)
        hacker = discord.Embed(
          color=0x2f3136,
          description=
          "<:IconTick:1213170250267492383> | Successfully Muted {0.mention} For {1} Minute(s)"
          .format(member, ok),
          timestamp=ctx.message.created_at)
      elif till.lower() == "s":
        t = timedelta(seconds=tame)
        hacker = discord.Embed(
          color=0x2f3136,
          description=
          "<:IconTick:1213170250267492383> | Successfully Muted {0.mention} For {1} Second(s)"
          .format(member, ok),
          timestamp=ctx.message.created_at)
      elif till.lower() == "h":
        t = timedelta(seconds=tame)
        hacker = discord.Embed(
          color=0x2f3136,
          description=
          "<:IconTick:1213170250267492383> | Successfully Muted {0.mention} For {1} Hour(s)"
          .format(member, ok),
          timestamp=ctx.message.created_at)
    try:
      if member.guild_permissions.administrator:
        hacker1 = discord.Embed(
          color=0x2f3136,
          description=
          "<:crosss:1212440602659262505> | I can\'t mute administrators",
          timestamp=ctx.message.created_at)
        await ctx.reply(embed=hacker1)
      else:
        await member.timeout(discord.utils.utcnow() + t,
                             reason="Command Used By: {0}".format(ctx.author))
        await ctx.send(embed=hacker)
    except:
    ...
    if member.is_timed_out():
      try:
        ...
        hacker5 = discord.Embed(
          color=0x00FFCA,
          description=
          f"<:IconTick:1213170250267492383> | Successfully Unmuted {member.name}",
          timestamp=ctx.message.created_at)
        ...
        hacker = discord.Embed(
          color=0x00FFCA,
          description=
          "<:crosss:1212440602659262505> | Unable to Remove Timeout:\n```py\n{}```"
          .format(e),
          timestamp=ctx.message.created_at)
        await ctx.send(embed=hacker)
    else:
      hacker1 = discord.Embed(
        color=0x00FFCA,
        description="<:crosss:1212440602659262505> | {} Is Not Muted".format(
          member.mention),
        timestamp=ctx.message.created_at)
  ...
  async def _kick(self,
    ...
    if ctx.author.top_role.position > member.top_role.position or member == ctx.guild.owner:
      ...
      hacker = discord.Embed(
        color=0x00FFCA,
        description=
        f"<:crosss:1212440602659262505> | {member.display_name} has been kicked from this guild, for: {reason}",
        timestamp=ctx.message.created_at)
      #hacker.set_footer(text=f"Made With 💖 By ~ GODFATHER ! </>#9417",icon_url= "https://media.discordapp.net/attachments/1066637418557624340/1068042323088379914/2491-couple-matching-1-2.gif")
      hacker.set_author(name=f"{ctx.author.name}",
                        icon_url=f"{ctx.author.avatar}")
      ...
      hacker1 = discord.Embed(
        ...
        timestamp=ctx.message.created_at)
      #hacker1.set_footer(text=f"Made With 💖 By ~ GODFATHER ! </>#9417",icon_url= "https://media.discordapp.net/attachments/1066637418557624340/1068042323088379914/2491-couple-matching-1-2.gif")
      # hacker1.set_thumbnail(url = "https://media.discordapp.net/attachments/1066637418557624340/1068042323088379914/2491-couple-matching-1-2.gif")
    ...
    if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
      await ctx.send(
        "*<:crosss:1212440602659262505> | You cannot kick someone with a higher role than you!*"
      )
  ...
  async def _warn(self,
    ...
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | {member.display_name} has been warned for: {reason}",
      timestamp=ctx.message.created_at)
  ...
  async def _ban(self,
    ...
    if ctx.author.top_role.position > member.top_role.position or ctx.author == ctx.guild.owner:
      ...
      hacker = discord.Embed(
        color=0x00FFE4,
        description=
        f"<:IconTick:1213170250267492383> | {member.display_name} has been successfully banned for the reason: `{reason}`",
        timestamp=ctx.message.created_at)
      hacker.set_author(name=f"{ctx.author.name}",
                        icon_url=f"{ctx.author.avatar}")
      hacker.set_thumbnail(url=f"{ctx.author.avatar}")
    ...
    if not ctx.author.top_role.position > member.top_role.position and ctx.author != ctx.guild.owner:
      embed = discord.Embed(
        color=0x00FFE4,
        description=
        f"*<:crosss:1212440602659262505> | You cannot ban someone with a higher role than you.*",
        timestamp=ctx.message.created_at)
      await ctx.send(embed=embed)
  ...
  async def _unban(self, ctx: commands.Context, id: int):
    ...
    hacker = discord.Embed(
      color=0x00FFCA,
      description=
      f"<:IconTick:1213170250267492383> | {user.name} has been successfully unbanned",
      timestamp=ctx.message.created_at)
    #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
  ...
  async def clone(self, ctx: commands.Context, channel: discord.TextChannel):
    ...
    hacker = discord.Embed(
      color=0x0d0d13,
      description=
      f"<:IconTick:1213170250267492383> | {channel.name} has been successfully cloned",
      timestamp=ctx.message.created_at)
    #hacker.set_footer(text=f"Made With 💖 By ~ Hacker_xD#0001",icon_url= "https://media.discordapp.net/attachments/1004709672588161044/1005073754889654343/a_9a2d97cca8cf934ac4b3624051ed9baf.gif")
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
  ...
  async def changenickname(self, ctx: commands.Context, member: discord.Member,
    ...
    hacker = discord.Embed(
      color=0x0d0d13,
      description=
      f"<:IconTick:1213170250267492383> | Successfully changed nickname of {member.name}",
      timestamp=ctx.message.created_at)
    hacker.set_author(name=f"{ctx.author.name}",
                      icon_url=f"{ctx.author.avatar}")
    hacker.set_thumbnail(url=f"{ctx.author.avatar}")
  ...
  async def do_removal(self,
    ...
    try:
      ...
      em = discord.Embed(description=f" Try a smaller search?", color=0x00FFCA)
      return await ctx.send(embed=em)
  ...
  async def _reactions(self, ctx, search=1000):
    ...
    await ctx.send(embed=discord.Embed(
      description=
      f"      <:IconTick:1213170250267492383> | Successfully Removed {total_reactions}.",
      color=0x0d0d13))
  ...
  async def _nuke(self, ctx: commands.Context):
    button = Button(label="Yes",
                    ...
                    emoji="<:IconTick:1213170250267492383>")
    button1 = Button(label="No",
                     style=discord.ButtonStyle.red,
                     emoji="<:crosss:1212440602659262505>")
  ...
  async def _lock(self,
    ...
    try:
      await channel.set_permissions(
        ...
        reason=reason)
      await ctx.send(embed=discord.Embed(
        title="Mystic | Lockdown",
        description=
        "<:IconTick:1213170250267492383> | Successfully locked **%s**" %
        (channel.mention),
        color=0x00FFCA))
    except:
      await ctx.send(
        embed=discord.Embed(title="Mystic | Lockdown",
  ...
  async def _unlock(self,
    ...
    try:
      await channel.set_permissions(
        ...
        reason=reason)
      await ctx.send(embed=discord.Embed(
        title="Mystic | Unlockdown",
        description=
        "<:IconTick:1213170250267492383> | Successfully unlocked **%s**" %
        (channel.mention),
        color=0x00FFCA))
    except:
      await ctx.send(
        embed=discord.Embed(title="Mystic | Unlockdown",
...
**Description:** {pack.description}
  ...
  async def temp(self, ctx, role: discord.Role, time, *, user: discord.Member):
    ...
    if role == ctx.author.top_role:
      embed = discord.Embed(
        description=
        f"<:crosss:1212440602659262505> | {role} has the same position as your top role!",
        color=0x0d0d13)
      ...
      if role.position >= ctx.guild.me.top_role.position:
        embed1 = discord.Embed(
          description=
          f"<:crosss:1212440602659262505> | {role} is higher than my role, move my role above {role}.",
          color=0x0d0d13)
    ...
    hacker = discord.Embed(
      description=
      f"<:IconTick:1213170250267492383> | Successfully added {role.mention} to {user.mention} .",
      color=0x0d0d13)
    await ctx.send(embed=hacker)
  ...
  async def remove(self, ctx, user: discord.Member, role: discord.Role):
    ...
    hacker = discord.Embed(
      description=
      f"<:IconTick:1213170250267492383> | Successfully removed {role.mention} from {user.mention} .",
      color=0x0d0d13)
    await ctx.send(embed=hacker)
  ...
  async def delete(self, ctx, role: discord.Role):
    ...
    if role is None:
      embed2 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505> | No role named {role} found in this server .",
        color=0x0d0d13)
      return await ctx.send(embed=embed2)
    await role.delete()
    hacker = discord.Embed(
      description=
      f"<:IconTick:1213170250267492383> | Successfully deleted {role}",
      color=0x0d0d13)
    await ctx.send(embed=hacker)
  ...
  async def create(self, ctx, *, name):
    ...
    if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
      hacker = discord.Embed(
        description=
        f"<:IconTick:1213170250267492383> | Successfully created role with the name {name}",
        color=0x0d0d13)
  ...
  async def rename(self, ctx, role: discord.Role, *, newname):
    ...
    if ctx.author == ctx.guild.owner or ctx.guild.me.top_role <= ctx.author.top_role:
      ...
      await ctx.send(
        f"<:IconTick:1213170250267492383> | Role {role.name} has been renamed to {newname}"
      )
    elif role is None:
      embed2 = discord.Embed(
        description=
  ...
  @blacklist_check()
  @ignore_check()
  async def wwerr(self, ctx, role: discord.Role):
    ''' Gives all the humans any role '''
    humans = [mem for mem in ctx.guild.members if not mem.bot]
    await ctx.send(
      "<:IconTick:1213170250267492383> | Adding roles to all humans")
    for h in humans:
      await h.add_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Added mentioned role to all members')
  ...
  async def jujk(self, ctx, role: discord.Role):
    ...
    await ctx.send("<:IconTick:1213170250267492383> | Adding roles to all")
    for h in all:
      await h.add_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Added mentioned role to all')
  ...
  async def lkj(self, ctx, role: discord.Role):
    ...
    await ctx.send(
      "<:IconTick:1213170250267492383> | Adding roles to all humans & bots")
    for h in humans:
      await h.add_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Added mentioned role to all bots')
  ...
  async def kljl(self, ctx, role: discord.Role):
    ...
    humans = [mem for mem in ctx.guild.members if not mem.bot]
    await ctx.send(
      "<:IconTick:1213170250267492383> | Removing roles from all humans")
    for h in humans:
      await h.remove_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Removed mentioned role from all members'
    )
  ...
  async def kjjk(self, ctx, role: discord.Role):
    ...
    await ctx.send("<:IconTick:1213170250267492383> | Removing roles from all")
    for h in humans:
      await h.remove_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Removed mentioned role from all')
  ...
  async def lkklkl(self, ctx, role: discord.Role):
    ...
    humans = [mem for mem in ctx.guild.members if mem.bot]
    await ctx.send(
      "<:IconTick:1213170250267492383> | Removing roles to all humans & bots")
    for h in humans:
      await h.remove_roles(role)
    await ctx.reply(
      '<:IconTick:1213170250267492383> | Removed mentioned role from all bots')
