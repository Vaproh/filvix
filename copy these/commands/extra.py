...
class Utility(commands.Cog):
    ...
    def __init__(self, bot):
        ...
        self.db = self.connection["<:IconTick:1213170250267492383>"]["servers"]
    ...
    async def stats(self, ctx):
        ...
        embed = discord.Embed(
            color=0x3498db,
            description=
            "[Invite](https://youtu.be/Aq5WXmQQooo?si=ZhwhMQg-7H_9imjo) | [Support](https://discord.gg/h1ontop)"
        )
        ...
        pain = await self.bot.fetch_user(765865384011628574)
        zeel = await self.bot.fetch_user(888310482774159360)
  

        embed.add_field(
            name='<:devloper:1215273270744588311>DEVELOPER',
            value=
        ...
        embed.set_footer(text='Thanks For Using <:IconTick:1213170250267492383>',
                         icon_url=self.bot.user.display_avatar.url)
    ...
    async def invite(self, ctx: commands.Context):
        embed = discord.Embed(
            description=
            "> • [Click Here To Invite Heavens To Your Server](https://youtu.be/dQw4w9WgXcQ)\n> • [Click Here To Join My Support Server](https://discord.gg/h1ontop)",
            color=0x3498db)
    ...
    async def invite(self, ctx: commands.Context):
        embed = discord.Embed(
            description=
            "> • [Click Here To Invite Heaven's To Your Server](https://youtu.be/Aq5WXmQQooo?si=ZhwhMQg-7H_9imjo)\n> • [Click Here To Join My Support Server](https://discord.gg/h1ontop)",
            color=0x0d0d13)

        await ctx.send(embed=embed)

    @commands.hybrid_command(name="vote", aliases=['dbl'], description="Vote Heaven's and Support Us")
    ...
    async def _vote(self, ctx):
        button = Button(label="Vote", url = "https://discord.gg/h1ontop")

        embed = discord.Embed(color=discord.Colour(0x0d0d13), description="**[Click Here](https://discord.gg/h1ontop)** To Vote For Heavens.")
        view = View()
        view.add_item(button)
        embed.set_author(name='Vote https://discord.gg/hontop',
  icon_url=self.bot.user.display_avatar.url)
    ...
    async def invite(self, ctx: commands.Context):
        embed = discord.Embed(
            description=
            "> • [Click Here To Invite Heavens's To Your Server](https://youtu.be/Aq5WXmQQooo?si=ZhwhMQg-7H_9imjo)\n> • [Click Here To Join My Support Server](https://discord.gg/h1ontop)",
            color=0x0d0d13)
        embed.set_author(name=f"{ctx.author.name}",
                         icon_url=f"{ctx.author.avatar}")
        await ctx.send(embed=embed)
...
**Color:** {member.color if member.color else '000000'}
    ...
    async def removeemoji(self, ctx, emoji: discord.Emoji):
        await emoji.delete()
        await ctx.send(
            "**<:IconTick:1213170250267492383> emoji has been deleted.**")
    ...
    async def _badges(self, ctx, user: Optional[discord.User] = None):
        ...
        if mem.public_flags.hypesquad:
            ...
            badges += "<:hypesquadbalance:1215686770570825768> **HypeSquad Balance**\n"

        elif mem.public_flags.hypesquad_bravery:
            badges += "<:hypesquadbravery:1215686743626350603> **HypeSquad Bravery**\n"
        elif mem.public_flags.hypesquad_brilliance:
            badges += "<:DGH_hypesquadbrillance:1215686832902377584> **Hypesquad Brilliance**\n"
        if mem.public_flags.early_supporter:
            ...
            badges += "<:ActiveDevBadge:1212438185301254185> **Active Developer**\n"
        if badges == "":
            badges = "None"
        if bdgs == []:
            ...
            embed2.add_field(
                name="**Bot Badges:**",
                value="**<:rinx3:1214657416659079219> Family**",
                inline=False)
    ...
    async def ping(self, ctx):
        embed = discord.Embed(
            title="""<a:icon_host:1214589584831160320> Ping """,
            description=f"```My Response Latency```\n```My Ping Is {int(self.bot.latency * 1000)} ms```",
            color=0x0f8be2)
        embed.set_footer(
                         icon_url=ctx.author.avatar.url if ctx.author.avatar
                         else ctx.author.default_avatar.url)
