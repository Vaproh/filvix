...
class Server(commands.Cog):
  ...
  async def add_role(self, *, role: int, member: discord.Member):
    if member.guild.me.guild_permissions.manage_roles:
      ...
      await member.add_roles(role, reason="Mystic | Role Added ")

  async def remove_role(self, *, role: int, member: discord.Member):
    if member.guild.me.guild_permissions.manage_roles:
      role = discord.Object(id=int(role))
      await member.remove_roles(role, reason="Heavens Arena | Role Removed")
  ...
  async def _owner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<:IconTick:1213170250267492383> | Successfully Given <@&{role}> To {member.mention}",
        color=0x00FFCA)
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
  ...
  async def _coowner(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Co Owner role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headadmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Head Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _admin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girladmin(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Girl Admin role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _headmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>  | Head Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _mod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505> Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _girlmod(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker1 = discord.Embed(
        description=
        f"<:crosss:1212440602659262505>   | Girl Mod role is not setuped in {context.guild.name}",
        color=0x00FFCA)
      hacker1.set_author(name=f"{context.author}",
                         icon_url=f"{context.author.avatar}")
      hacker1.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def staff(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Staff` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girl(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `girl` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def vip(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `vip` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def guest(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `guest` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def friend(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `friend` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def owner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def coowner(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Co Owner` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headadmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Head Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def admin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def headmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Head Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def mod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girladmin(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Girl Admin` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def girlmod(self, context: Context, role: discord.Role) -> None:
    if context.author == context.guild.owner or context.author.top_role.position > context.guild.me.top_role.position:
      if data := getConfig(context.guild.id):
        ...
        hacker = discord.Embed(
          description=
          f"<:IconTick:1213170250267492383> | Successfully Setuped `Girl Mod` Role To {role.mention}",
          color=0x00FFCA)
        hacker.set_author(name=f"{context.author}",
                          icon_url=f"{context.author.avatar}")
        hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def rstaff(self, context: Context, member: discord.Member) -> None:
    if data := getConfig(context.guild.id):
      ...
      hacker = discord.Embed(
        description=
        f"<:IconTick:1213170250267492383> | Successfully Removed <@&{role}> From {member.mention}",
        color=0x00FFCA)
      hacker.set_author(name=f"{context.author}",
                        icon_url=f"{context.author.avatar}")
      hacker.set_thumbnail(url=f"{context.author.avatar}")
  ...
  async def _create(self, ctx, name, *, message):
    ...
    if str(ctx.guild.id) in autoresponse:
      ...
      if len(numbers) >= 20:
        hacker6 = discord.Embed(
          title="Heavens Arena",
          description=
          f"<:crosss:1212440602659262505>  You can\'t add more than 20 autoresponses in {ctx.guild.name}",
          color=0x00FFCA)
    ...
    if str(ctx.guild.id) in autoresponse:
      ...
      hacker1 = discord.Embed(
        title="Heavens Arena",
        description=
        f"<:IconTick:1213170250267492383>  | Successfully Created Autoresponder in {ctx.guild.name} with the `{name}`",
        color=0x00FFCA)
    ...
    if str(ctx.guild.id) in autoresponse:
      if name in autoresponse[str(ctx.guild.id)]:
        ...
        hacker1 = discord.Embed(
          title="Heavens Arena",
          description=
          f"<:IconTick:1213170250267492383> | Successfully Deleted Autoresponder in {ctx.guild.name} with the `{name}`",
          color=0x00FFCA)
        ...
        hacker = discord.Embed(
          title="Heavens Arena",
          description=
          f"<:crosss:1212440602659262505>  No Autoresponder Found With The Name `{name}` In {ctx.guild.name}",
          color=0x00FFCA)
        hacker.set_author(name=f"{ctx.author}",
                          icon_url=f"{ctx.author.avatar}")
        hacker.set_thumbnail(url=f"{ctx.author.avatar}")
      ...
      hacker2 = discord.Embed(
        title="Heavens Arena",
        description=
        f"<:crosss:1212440602659262505> There is no Autoresponder in {ctx.guild.name}",
        color=0x00FFCA)
      hacker2.set_author(name=f"{ctx.author}", icon_url=f"{ctx.author.avatar}")
      hacker2.set_thumbnail(url=f"{ctx.author.avatar}")
      return await ctx.reply(embed=hacker2)
    ...
    if str(ctx.guild.id) in autoresponse:
      if name in autoresponse[str(ctx.guild.id)]:
        ...
        hacker1 = discord.Embed(
          title="Mystic",
          description=
          f"<:IconTick:1213170250267492383>  | Successfully Edited Autoresponder in {ctx.guild.name} with the `{name}`",
          color=0x00FFCA)
        hacker1.set_author(name=f"{ctx.author}",
                           icon_url=f"{ctx.author.avatar}")
        hacker1.set_thumbnail(url=f"{ctx.author.avatar}")
