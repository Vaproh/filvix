...
class Media(commands.Cog):
    ...
    async def setup(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<:IconTick:1213170250267492383> | Successfully added {channel.mention} in media only channels.")
    ...
    async def remove(self, ctx, *, channel: discord.TextChannel):
        ...
        await ctx.send(f"<:IconTick:1213170250267492383> | Successfully removed {channel.mention} from media only channels.")
    ...
    async def reset(self, ctx):
        ...
        await ctx.send("<:IconTick:1213170250267492383> | Successfully removed all the media only channels.")
