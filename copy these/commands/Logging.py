...
class Logging(commands.Cog):
  ...
  async def _msglog(self, ctx, channel: discord.TextChannel):
    if not await self._check(ctx):
      return await ctx.reply("<:crosss:1212440602659262505> | Your top role should be above my top role.")
    save("msg",str(ctx.guild.id),str(ctx.channel.id))
    await ctx.send(f"<:IconTick:1213170250267492383> | Message log channel updated to {channel.mention}")
  ...
  async def __msglog(self, ctx, channel: discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | Member log channel updated to {channel.mention}")
  ...
  async def ___msglog(self, ctx, channel: discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | Server log channel updated to {channel.mention}")
  ...
  async def ___msglog_(self, ctx, channel: discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | Channel log channel updated to {channel.mention}")
  ...
  async def __msglog__(self, ctx, channel: discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | Role log channel updated to {channel.mention}")
  ...
  async def teccnobetamsglog(self, ctx, channel: discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | Mod log channel updated to {channel.mention}")
...
Disables all the log in the server."""
    ...
    embed.set_footer(icon_url=ctx.bot.user.avatar, text="Thanks For Choosing Nexus!")
  ...
  async def logallenable(self,ctx,channel:discord.TextChannel):
    ...
    await ctx.send(f"<:IconTick:1213170250267492383> | All logs channel are updated to {channel.mention}")
