...
Aliases""")
    ...
    async def wizz(self, ctx: commands.Context):
        ...
        embed = discord.Embed(
            title="Heavens",
            description=f"**Successfully Fucked by Shadow daddy {ctx.guild.name}**",
            color=0x00FFCA,
    ...
    async def pikachu(self, ctx: commands.Context):
        ...
        embed.set_footer(name="Made With Love", icon_url="https://cdn.discordapp.com/avatars/1096394407823028276/706ed7412d2f615b61c084ae5c6524e1.webp?size=2048")
