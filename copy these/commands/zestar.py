...
class Zestar(Cog):
    ...
    async def on_message(self, message):
      button = Button(label="Invite Heavens", url =  "https://youtu.be/Aq5WXmQQooo?si=OXpww9lC6Vg5eBHO")
      button1 = Button(label="Support Server", url = "https://discord.gg/h1ontop")
      button2 = Button(label="Vote Me", url = "https://discord.gg/h1ontop")
      try:
        ...
        with open('ignore.json', 'r') as heck:
          ...
          if message.mention_everyone:
            ...
            if str(message.author.id) in data2["ids"]:
              embed = discord.Embed(title="<:blacklist:1217854048993280020> Blacklisted", description="You Are Blacklisted From Using My Commands.\nIf You Think That It Is A Mistake, You Can't Appeal In Our Support Server By Clicking [here](https://discord.gg/h1ontop)")
