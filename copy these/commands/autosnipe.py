...
class autosnipe(commands.Cog):
    def __init__(self, bot):
        ...
        self.db = self.connection["Nexus"]["servers"]
    ...
    async def channel(self, ctx, c: discord.TextChannel):
        try:
            ...
            await ctx.send(f"<:IconTick:1213170250267492383>  | autosnipe channel are updated to <#{c.id}>")
    ...
    async def delete(self, ctx: commands.Context):
        ...
        await ctx.send(f'<:IconTick:1213170250267492383> | Successfully Deleted autosnipe Channel')
